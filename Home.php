...
<p>
	...
	<br>
	For each compound we have the following informations along with the abbreviation :
	<br>
	<ul class="b">
...
<b>2. Stats</b>
<br>
	For this part, it provides three ways (by <a href="Manufacture.php" class="contentInd">Manufactures</a>, <a href="Feature_Statis_display.php" class="contentInd">Features</a>, and<a href="correlation.php" class="contentInd">Correlations</a> ) to view the statistics of compounds in the whole database. 
	<br>
	<br>
	<b>3. Search</b>
	<br>
