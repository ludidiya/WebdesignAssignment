...
<h2>3. Molecule File</h2><br>
<p><b>SDF format of Compound <?php echo $cid ?></b></p>
<textarea id="content" rows="20" cols="180" style="text-align: center;width: 100%;font-size: 15px;"><?php echo $sdf ?></textarea>
